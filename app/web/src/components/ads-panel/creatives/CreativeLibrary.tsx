...
export function CreativeLibrary({ projectId }: CreativeLibraryProps) {
  const { creatives, isLoadingCreatives, fetchCreatives, deleteCreative, selectedEntityToView, setSelectedEntityToView } = useAdsStore();
  ...
  const handleOpenEdit = (creative: AdCreative) => {
