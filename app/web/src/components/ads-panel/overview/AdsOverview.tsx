...
export function AdsOverview({ projectId }: AdsOverviewProps) {
  const { campaigns, isLoadingCampaigns, fetchCampaigns, overviewData, isLoadingOverview, fetchOverview, observations, fetchObservations } = useAdsStore();
