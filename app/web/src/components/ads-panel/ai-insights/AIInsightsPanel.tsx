...
import { AdAIObservation } from '@/types/ads';
...
const TYPE_LABELS: Record<string, string> = {
  ...
  const { observations, isLoadingObservations, isGeneratingAI, fetchObservations, generateDailySummary, acknowledgeObservation, deleteObservation } = useAdsStore();
  ...
  const renderCard = (obs: AdAIObservation) => {
