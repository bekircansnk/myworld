...
export function CampaignForm({ onClose, projectId, initialData }: CampaignFormProps) {
  const { createCampaign, updateCampaign, experiments, creatives, adsTasks, fetchExperiments, fetchCreatives, fetchTasks, setViewMode, setSelectedEntityToView } = useAdsStore();
