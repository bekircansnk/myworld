...
export function NotesList() {
  ...
  const filteredNotes = React.useMemo(() => {
    ...
    return notes.filter(n => {
      ...
      if (activeTab === "Yaratıcı Fikirler") return catLower.includes("yaratıcı") || catLower.includes("fikir")
      if (activeTab === "Genel Notlar") return catLower.includes("genel") || !cat
      if (activeTab === "Yazılım") return catLower.includes("yazılım") || catLower.includes("kod")
      return true
    })
