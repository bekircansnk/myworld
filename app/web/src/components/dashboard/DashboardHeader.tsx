    ...
    <div className="flex flex-col gap-6 mb-2">
      ...
      <header className="flex flex-wrap items-center justify-between gap-4 border-b border-brand-lightGray/50 dark:border-white/5 pb-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button aria-label="Bildirimler" className="w-10 h-10 bg-card border border-border rounded-full flex items-center justify-center shadow-sm hover:bg-gray-50 dark:hover:bg-white/5 transition-colors relative">
