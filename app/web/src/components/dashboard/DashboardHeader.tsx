    ...
    <div className="flex flex-col gap-6 mb-2">
      ...
      <header className="flex flex-wrap items-center justify-between gap-4 border-b border-brand-lightGray/50 dark:border-white/5 pb-4">
        <nav className="flex items-center space-x-1 md:space-x-4 overflow-x-auto pb-2 scrollbar-hide">
          <button className="bg-primary text-primary-foreground px-5 py-2.5 rounded-full text-sm font-medium whitespace-nowrap">Dashboard</button>
        ...
        <div className="flex items-center space-x-3">
          <div className="relative w-full lg:w-[280px]">
            <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-brand-gray dark:text-gray-400" aria-hidden="true" />
            <input 
              type="text" 
          ...
          >
            {mounted && theme === "dark" ? <Sun className="w-4 h-4 text-brand-yellow" aria-hidden="true" /> : <Moon className="w-4 h-4 text-brand-dark" aria-hidden="true" />}
          </button>
        </div>
      </header>
        ...
        <div className="mb-4 lg:mb-0">
          ...
          <div className="flex flex-wrap gap-4 items-end">
            <div>
              ...
              <div className="bg-primary text-primary-foreground px-4 py-1.5 rounded-full text-xs font-medium">+15%</div>
            </div>
            <div>
            ...
            <div className="flex-grow min-w-[200px]">
              ...
              <div className="h-6 w-full bg-muted rounded-full flex overflow-hidden border border-border">
