    ...
    <div className="glass-card flex flex-col rounded-2xl h-full relative overflow-hidden group">
      ...
      <div className="p-3 flex-1 flex flex-col items-center justify-center relative z-10">
        ...
        <div className="flex items-center gap-3 w-full justify-center">
          ...
          <Button onClick={resetTimer} variant="ghost" size="icon" className="h-9 w-9 rounded-xl bg-muted/40 hover:bg-muted/60 border border-border text-slate-600 dark:text-slate-300 btn-3d" disabled={isLoading} aria-label="Zamanlayıcıyı sıfırla" title="Sıfırla">
