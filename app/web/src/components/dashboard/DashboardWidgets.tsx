...
export function DashboardWidgets() {
  ...
  // === TASK STATS (LIVE) ===
  // ⚡ Bolt Optimization: Memoized task filtering to prevent O(N) recalculations on every render cycle.
  // This is critical because this component contains a live timer (setInterval) causing frequent re-renders.
  const { mainTasks, todoTasks, doneTasks, inProgressTasks, totalTasks, completionRate } = React.useMemo(() => {
    ...
    return { mainTasks: main, todoTasks: todo, doneTasks: done, inProgressTasks: inProgress, totalTasks: total, completionRate: rate }
  }, [tasks])
