          ...
          <div className="hidden lg:flex floating-card rounded-3xl p-6 lg:flex-grow lg:min-h-0 flex-col gap-3 overflow-hidden">
            ...
            <div className="mt-auto pt-1 shrink-0">
              <div className="relative">
                ...
                />
                <button aria-label="Gönder" onClick={sendAiMessage} className="absolute right-2 top-1.5 w-8 h-8 bg-primary text-primary-foreground rounded-xl flex items-center justify-center hover:opacity-80 transition">
        ...
        <div className="col-span-1 lg:col-span-6 flex flex-col gap-4 lg:min-h-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 shrink-0">
            ...
            <div className="floating-card rounded-3xl p-5 flex flex-col relative overflow-hidden min-h-[220px]">
              <button aria-label="Ayarlar" className="absolute top-5 right-5 w-8 h-8 bg-brand-bg dark:bg-slate-900 rounded-full flex items-center justify-center hover:bg-gray-100 dark:hover:bg-slate-700 transition shrink-0">
            ...
            <div className="floating-card rounded-3xl p-5 flex flex-col 2xl:flex-row relative overflow-hidden gap-4 min-h-[220px]">
              <div className="w-full 2xl:w-[50%] flex flex-col items-center justify-between 2xl:border-r border-b 2xl:border-b-0 border-slate-100 dark:border-white/5 pb-4 2xl:pb-0 2xl:pr-4 relative gap-3">
                ...
                <div className="flex space-x-2">
                  {!isTimerRunning ? (
                    <button aria-label="Başlat" onClick={startTimer} className="w-8 h-8 bg-emerald-500 shadow-sm rounded-full flex items-center justify-center hover:bg-emerald-600 transition shrink-0">
                      <Play className="w-3.5 h-3.5 text-white ml-0.5" />
                    </button>
                  ) : (
                    <button aria-label="Duraklat" onClick={pauseTimer} className="w-8 h-8 bg-amber-500 shadow-sm rounded-full flex items-center justify-center hover:bg-amber-600 transition shrink-0">
                      <Pause className="w-3.5 h-3.5 text-white" />
                    </button>
                  )}
                  <button aria-label="Sıfırla" onClick={resetTimer} className="w-8 h-8 bg-card shadow-sm border border-border rounded-full flex items-center justify-center hover:bg-muted transition shrink-0">
