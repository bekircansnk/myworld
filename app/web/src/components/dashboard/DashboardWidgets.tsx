...
export function DashboardWidgets() {
  ...
  const { mainTasks, todoTasks, doneTasks, inProgressTasks, totalTasks, completionRate } = React.useMemo(() => {
    // ⚡ Bolt: Added useMemo to prevent O(N) recalculations on every keystroke in aiInput.
    // This optimization reduces unnecessary work on the main thread during frequent renders.
