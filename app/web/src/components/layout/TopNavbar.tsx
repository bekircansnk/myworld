        ...
        <div className="flex items-center gap-0.5 sm:gap-1 md:gap-2 shrink-0">
          ...
          <div className="relative" ref={notifRef}>
            <button
              ...
              title="Bildirimler"
              className="w-9 h-9 md:w-10 md:h-10 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors relative focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
            >
          ...
          {mounted && (
            <button
              ...
              className="w-9 h-9 md:w-10 md:h-10 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
            >
          ...
          <div className="relative" ref={userRef}>
            <button
              ...
              className={`relative w-9 h-9 md:w-10 md:h-10 rounded-full flex items-center justify-center transition-colors overflow-hidden border-2 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none ${showUserPanel ? 'border-brand-yellow' : 'border-transparent bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700'}`}
            >
              {user?.avatar_url ? (
                    ...
                    onClick={async (e) => {
                      ...
                      try {
                        ...
                        if (res.ok) {
                          ...
                          window.open("https://myworld-twqx.onrender.com/static/Planla_v6.8.apk", "_blank"); // Fallback
                        }
                      } catch (err) {
                        window.open("https://myworld-twqx.onrender.com/static/Planla_v6.8.apk", "_blank"); // Fallback
                      }
